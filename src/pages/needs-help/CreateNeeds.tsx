...
<div className="col-span-full my-40">
          <label htmlFor="cover-photo" className="text-left text-[3rem] block text-sm font-medium leading-6 text-gray-900">Завантажте фото *</label>
          <div className="mt-20 flex justify-center  rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
            <div className="text-center">
              ...
              <div className="mt-4  flex text-sm leading-6 text-gray-600">
                <label htmlFor="file-upload" className="bg-blue-600 flex flex-grow items-center justify-end  relative mx-10 cursor-pointer rounded-full bg-white font-semibold text-indigo-600 focus-within:outline-none focus-within:ring-2 focus-within:ring-indigo-600 focus-within:ring-offset-2 hover:text-indigo-500">
      ...
      <a href="/reg" className=" w-180 block w-full my-[18rem] ml-[18rem] justify-end mx-4 px-3 py-2 bg-[#5ff543] border-[2px] border-[solid] border-[#FEFCF4]   rounded-[4px] text-center text-sm font-semibold text-black shadow-sm hover:bg-[#FEFCF4] hover:text-[#5BC0EB] hover:border-[#5BC0EB]   focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Опублікувати</a>
      </div>
